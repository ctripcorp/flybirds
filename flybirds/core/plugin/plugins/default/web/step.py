...
class Step:
    ...
    @classmethod
    def click_if_exist_selector(cls, context, selector, param1):
        ele = gr.get_value("plugin_ele")
        ele.click_param_if_exist_selector_web(context, selector, param1)
    ...
    @classmethod
    def full_screen_swipe_new(cls, context, param, selector):
        ele = gr.get_value("plugin_ele")
