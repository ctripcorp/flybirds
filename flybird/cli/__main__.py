...
from flybird.cli.create_project import create_demo
from flybird.cli.parse_args import parse_args, default_report_path
from flybird.core.launch_cycle.run_manage import run_script

app = typer.Typer(
    help='Welcome to flybird. Type "--help" for more information.',
...
def runner(
        ...
        tag: str = typer.Option(
            ...
            help="Run scenarios with a specific tag. "
                 ...
                 "commas(,). "
                 "e.g. flybird run --tag tag1,-tag2,tag4",
        ),
