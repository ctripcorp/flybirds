...
app base step class
"""
import flybird.core.plugin.plugins.default.step.app as step_app
import flybird.core.plugin.plugins.default.step.attr as step_attr
import flybird.core.plugin.plugins.default.step.click as step_click
import flybird.core.plugin.plugins.default.step.common as step_common
import flybird.core.plugin.plugins.default.step.page_show_adjust as step_adjust
import flybird.core.plugin.plugins.default.step.record as step_record
import flybird.core.plugin.plugins.default.step.swipe as step_swipe
import flybird.core.plugin.plugins.default.step.verify as step_verify
from flybird.core.plugin.plugins.default.step.input import ele_input
from flybird.core.plugin.plugins.default.step.position import (
    position_not_change
)
