...
from flybird.report.fail_feature_create import rerun_launch
from flybird.utils.pkg_helper import load_pkg_by_ns
...
class RunManage:
    ...
    def load_pkg():
        ...
        load report ref
        """
        load_pkg_by_ns("flybird.core.launch_cycle")
        load_pkg_by_ns("flybird.report.gen")
