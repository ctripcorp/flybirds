...
class TagExpression(object):
    ...
    def __init__(self, tag_expressions):
        ...
        for expr in tag_expressions:
            log.info("tag_expressions: {}".format(tag_expressions))
    ...
    def store_and_extract_limits(self, tags):
        ...
        for tag in tags:
            ...
            if tag:
                ...
                if limited and self.limits[tag_without_negation] != limit:
                    ...
                    msg = msg.format(
                        tag_without_negation,
                        self.limits[tag_without_negation],
                        limit,
                    )
                    raise Exception(msg)
        ...
        if tags_with_negation:
            log.info("tags_with_negation: {}".format(tags_with_negation))
    ...
    def __str__(self):
        ...
        if six.PY2:
            return u" ".join(and_parts).encode("utf-8")
